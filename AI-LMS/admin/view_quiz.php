          ...
          <div class="page-inner">
            ...
            <?php
              ...
              if (isset($_GET['delete_id'])) {
                  ...
                  // Delete query
                  $query = "DELETE FROM `quiz_tbl` WHERE `quiz_id`='$quiz_id'";
                  $result = mysqli_query($conn, $query);

                  if ($result) {
                      echo "<script>alert('Quiz Details deleted successfully!'); window.location.href='view_quiz.php';</script>";
                  } else {
                      echo "<script>alert('Error deleting Quiz details: " . mysqli_error($conn) . "');</script>";
                  }
              }
            ?>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                      <h4 class="card-title">View Quiz Details</h4>
                      <a href="add_quiz.php" class="btn btn-primary btn-round ms-auto">
                      ...
                      <tbody>
                            ...
                            if(!$result) {
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  <td>
                                  <button type='button' class='btn btn-link btn-primary btn-md' data-bs-toggle='modal' data-bs-target='#exampleModal' title='Edit' onclick='editClass({$row['id']})'>
                                  <i class='fa fa-edit'></i>
                                  </button>
                                  <button type='button' class='btn btn-link btn-warning btn-md' data-bs-toggle='modal' title='Delete'>
                                  <a href='view_quiz.php?delete_id={$row['quiz_id']}' class='btn btn-link btn-danger btn-md' 
                                      onclick='return confirm(\"Are you sure you want to delete this Quiz Details?\");'>
