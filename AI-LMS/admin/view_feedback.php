        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">View Users FeedBack</h3>
            ...
            <?php
              ...
              if (isset($_GET['delete_id'])) {
                  $feed_id = $_GET['delete_id'];

                  // Delete query
                  $query = "DELETE FROM `feedback_tbl` WHERE `feed_id`='$feed_id'";
                  $result = mysqli_query($conn, $query);

                  if ($result) {
                      echo "<script>alert('Feedback Details deleted successfully!'); window.location.href='view_feedback.php';</script>";
                  } else {
                      echo "<script>alert('Error deleting feedback details: " . mysqli_error($conn) . "');</script>";
                  }
              }
            ?>
                          ...
                          <tbody>
                            ...
                            if(!$result) {
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  <a href='view_feedback.php?delete_id={$row['feed_id']}' class='btn btn-link btn-danger btn-md' 
                                      onclick='return confirm(\"Are you sure you want to delete this Feedback Details?\");'>
